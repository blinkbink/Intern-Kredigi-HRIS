                                                        ...
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <td><?php
                                                                    ...
                                                                    ?> (Hari Ini)</td>
                                                               <input name="tanggal_pengajuan" value="<?php echo date("Y-m-d");?>" type="hidden" class="form-control" >
                                                            </tr>
                                                            <tr>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-5">
                                                                            <div class="input-group" >
                                                                                <input name="tanggal_cuti" id="datepicker" class="form-control" readonly placeholder="" type="text" required>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-lg-5">
                                                                            <div class="input-group">
                                                                                <input name="lama_cuti" type="number" min="1" max="<?php echo $sisa?>" class="form-control" required oninvalid="this.setCustomValidity('Jumlah Hari Tidak Boleh Kosong dan tidak melebihi sisa jatah cuti')"
                                                            ...
                                                            <tr>
                                                                <td>Keterangan</td>
                                                                <td>
                                                                    <textarea name="keterangan" style="overflow:auto;resize:none" rows="6" cols="80" required oninvalid="this.setCustomValidity('Keterangan Tidak Boleh Kosong')"
