                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    if($dataCuti != null) {
                                                        foreach ($dataCuti as $k) {
                                                            $tanggal_mulai_kerja = new DateTime($k['mulai_kerja']);
                                                            $tanggal_hari_ini = new DateTime(date("Y-m-d"));
                                                            $tahun = $tanggal_hari_ini->diff($k['mulai_kerja'])->format("%a");
                                                        }
                                                    }
                                                    ...
                                                    if($total_kerja <= 365)
                                                    {
                                                     ...
                                                     else if( $total_kerja > 365 && $tahun == null)
                                                    {
                                                        ?>
                                                        <div align="left" class="col-md-7">
                                                            <button onclick="location.href='<?php echo base_url() . "index.php/cuti/form_cuti" ?>'" class="btn display-block font-normal btn-success">+ Pengajuan Cuti Tahunan</button>
                                                        </div>
                                                        <br><br><br><br>
                                                        <h1 align="center">Belum Ada Data</h1><?php
                                                        echo $tahun ?>
                                                        <?php
                                                    }
                                                            ...
                                                            foreach ($hitungCuti as $st) {
                                                                ...
                                                                if ($st['total'] >= 1) {
                                                                    ...
                                                                    <div align="center" class="col-md-7">
                                                                        <button onclick="location.href='<?php echo base_url() . "index.php/cuti/form_cuti" ?>'"
                                                                                class="btn display-block font-normal btn-success"
                                                                                disabled>+ Pengajuan Cuti Tahunan
                                                                        </button>
                                                                    </div>
                                                                    <br><br><br>
                                                                    <p><font color="red">*</font> Pengajuan Cuti anda
                                                                        sedang di proses</p>
                                                                    <?php
                                                                } else if ($status_terakhir == "Disetujui" && $tahun_cuti == $tahun_sekarang && $sisa <= 0) {
                                                                    ?>
                                                                    <div align="center" class="col-md-7">
                                                                        <button onclick="location.href='<?php echo base_url() . "index.php/cuti/form_cuti" ?>'"
                                                                                class="btn display-block font-normal btn-success"
                                                                    ...
                                                                    <br><br><br>
                                                                    <p><font color="red">*</font> Kamu tidak Bisa
                                                                        Mengajukan Cuti Tahunan Lebih dari 12 hari dalam
                                                                        setahun</p>
                                                                    <?php
                                                                }
                                                                else if ($status_terakhir == "Disetujui" && $tahun_cuti == $tahun_sekarang && $sisa > 0) {
                                                                    ...
                                                                    <div align="center" class="col-md-7">
                                                                        <button onclick="location.href='<?php echo base_url() . "index.php/cuti/form_cuti" ?>'"
                                                                                class="btn display-block font-normal btn-success">+ Pengajuan Cuti Tahunan
                                                                        </button>
                                                                    </div>
                                                                    <?php
                                                                } else if ($status_terakhir == "Batal" || $status_terakhir == "Tidak Disetujui") {
                                                                    ?>
                                                                    <div align="center" class="col-md-7">
                                                                        <button onclick="location.href='<?php echo base_url() . "index.php/cuti/form_cuti" ?>'"
                                                                                class="btn display-block font-normal btn-success">
                                                        ...
                                                        ?>
                                                        <div class="table-responsive">
                                                            <p align="right"><?php echo "Sisa Jatah Cuti ". $sisa." Hari"; ?></p>
                                                                    ...
                                                                    <tr class="even pointer">
                                                                        ...
                                                                        <td class=" ">
                                                                            ...
                                                                            if ($d['status'] == "Menunggu") {
                                                                                ?>
                                                                                <a href="cuti/detail_cuti/<?php echo $d['id_cuti'] ?>" class="fa fa-eye"></a>
                                                                                <a href="cuti/batal_cuti/<?php echo $d['id_cuti'] ?>"
                                                                                   onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan izin ini ?')" class="fa fa-remove"></a>
                                                                                <a href="cuti/edit_cuti/<?php echo $d['id_cuti'] ?>" class="fa fa-pencil"></a>
                                                                                <?php
                                                                            } else if ($d['status'] == "Batal" || $d['status'] == "Tidak Disetujui") {
                                                                                ?>
                                                                                <a href="cuti/detail_cuti/<?php echo $d['id_cuti'] ?>" class="fa fa-eye"></a>
                                                                                <?php
                                                                            } else if ($d['status'] == "Disetujui" && $d['batas'] < 0) {
                                                                                ?>
                                                                                <a href="cuti/detail_cuti/<?php echo $d['id_cuti'] ?>" class="fa fa-eye"></a>
                                                                                <a href="cuti/batal_cuti/<?php echo $d['id_cuti'] ?>"
                                                                                   onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan izin ini ?')" class="fa fa-remove"></a>
                                                                                <?php
                                                                            } else if ($d['batas'] >= 0 && $d['status'] == "Disetujui") {
                                                                                ?>
                                                                                <a href="cuti/detail_cuti/<?php echo $d['id_cuti'] ?>" class="fa fa-eye"></a>
                                                                                <?php
                                                                            } else {
