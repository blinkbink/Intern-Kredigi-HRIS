                                        ...
                                        <div class="x_content">
                                            <div align="center" class="col-md-12">
                                                <div class="table-responsive">
                                                    ...
                                                    foreach ($data as $d) {
                                                    ?>
                                                    <?php echo form_open_multipart('cuti/edit_cuti/'.$d['id_cuti']);?>
                                                    <div align="center" class="col-md-10">
                                                        ...
                                                        <table class="table">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-5">
                                                                            <div class="input-group date datepicker" >
                                                                                <input value="<?php echo date("d-m-Y", strtotime($d['tanggal_cuti']))?>" name="tanggal_cuti" class="form-control" placeholder="" readonly="" type="text" oninvalid="this.setCustomValidity('Tanggal Cuti Tidak Boleh Kosong')"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-5">
                                                                            <div class="input-group">
                                                                                <input value="<?php echo $d['lama_cuti']?>" name="lama_cuti" type="number" min="1" max="<?php echo $sisa?>" class="form-control" required oninvalid="this.setCustomValidity('Jumlah Hari Tidak Boleh Kosong dan tidak melebihi sisa jatah cuti')"
                                                                           oninput="setCustomValidity('')"><font color="red">*</font> Minimal 1 hari, Sisa Jatah Cuti <?php echo $sisa?> Hari
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>Keterangan</td>
                                                                <td><textarea value="<?php echo $d['keterangan']?>" name="keterangan" style="overflow:auto;resize:none" rows="6" cols="80" required oninvalid="this.setCustomValidity('Keterangan Tidak Boleh Kosong')"
                                                                              oninput="setCustomValidity('')"><?php echo $d['keterangan']?></textarea></td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <div class="col-md-1">
                                                            <button class="btn display-block font-normal btn-default"
                                                                    onclick="location.href='<?php echo base_url()."index.php/cuti"?>';">Batal
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <?php
