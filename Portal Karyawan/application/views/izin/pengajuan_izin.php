                                                        ...
                                                        foreach ($status as $st)
                                                            if($st['total'] >= 2) {
                                                                ...
                                                                <div align="center" class="col-md-5">
                                                                    <button onclick="location.href='<?php echo base_url() . "index.php/izin/form_izin" ?>'" disabled class="btn display-block font-normal btn-success">+ Pengajuan Izin</button>
                                                                </div>
                                                                <br><br><br>
                                                                ...
                                                                ?>
                                                                <div align="center" class="col-md-5">
                                                                    <button onclick="location.href='<?php echo base_url(). "index.php/izin/form_izin"?>'" class="btn display-block font-normal btn-success">+ Pengajuan Izin</button>
                                                                </div>
                                                                <?php
                                                            }
                                                        ?>
                                                                    ...
                                                                    foreach ($data as $d) {
                                                                        ...
                                                                        <tr class="even pointer">
                                                                            ...
                                                                            <td class=" ">
                                                                                ...
                                                                                $convert = strtotime($d['tanggal_izin']);
                                                                            ...
                                                                            <td class=" ">
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <a href="izin/detail_izin/<?php echo $d['id_izin']?>" class="fa fa-eye"></a>
                                                                                    <a href="izin/batal_izin/<?php echo $d['id_izin']?>" class="fa fa-remove" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan izin ini ?')"></a>
                                                                                    <a href="izin/edit_izin/<?php echo $d['id_izin']?>" class="fa fa-pencil"></a>
                                                                                    <?php
                                                                                }
