...
<div class="user-panel">
    ...
    <div class="pull-left info">
        ...
        <a href="<?php echo base_url()."index.php/karyawan/kata_sandi"?>">Ubah Kata Sandi</a>
    </div>
</div>
<!-- search form -->
...
<ul class="sidebar-menu">
    ...
    <li>
        <a href="<?php echo base_url()."index.php/tim"?>">
    ...
    <li class="treeview ">
        <a href="#">
            <i class="fa fa-tint"></i><span>Sakit, Izin Lainnya</span>
