                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div align="center" class="col-md-12">
                                        ...
                                        foreach ($data as $d) {
                                            ?>
                                            <form action="<?php echo base_url() . "index.php/karyawan/save" ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="email"
                                                               value="<?php echo $d['email_karyawan'] ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="agama" class="form-control">
                                                            <option value="Islam" <?php if ($d['opt_agama'] == "Islam") echo 'selected="selected"' ?>>
                                                                Islam
                                                            </option>
                                                            <option value="Katolik" <?php if ($d['opt_agama'] == "Katolik") echo 'selected="selected"' ?>>
                                                                Katolik
                                                            </option>
                                                            <option value="Protestan" <?php if ($d['opt_agama'] == "Protestan") echo 'selected="selected"' ?>>
                                                                Protestan
                                                            </option>
                                                            <option value="Hindu" <?php if ($d['opt_agama'] == "Hindu") echo 'selected="selected"' ?>>
                                                                Hindu
                                                            </option>
                                                            <option value="Buddha" <?php if ($d['opt_agama'] == "Buddha") echo 'selected="selected"' ?>>
                                                                Buddha
                                                            </option>
                                                            <option value="Kong Hu Cu" <?php if ($d['opt_agama'] == "Kong Hu Cu") echo 'selected="selected"' ?>>
                                                                Kong Hu Cu
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                        ...
                                                        <button onclick="location.href='<?php echo base_url()."index.php/karyawan/profile" ?>';" class="btn btn-primary" type="button">
                                                            Batal
                                                        </button>
                                                    </div>
                                                </div>
