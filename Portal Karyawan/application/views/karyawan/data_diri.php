                                                    ...
                                                    foreach($data as $d) {
                                                        ...
                                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                                            <div class="x_panel">
                                                                        ...
                                                                        <table class="table">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    $convert = $d['mulai_kerja'];
                                                                                    echo $hari[date("w", strtotime($convert))].", ".date("j", strtotime($convert))." ".$bulan[date("n", strtotime($convert))]." ".date("Y", strtotime($convert));
                                                                ...
                                                                {
                                                                    ?>
                                                                    <button onclick="location.href='<?php echo base_url(). "index.php/karyawan/edit"?>'" class="btn display-block font-normal btn-warning">Pengajuan Perubahan Data</button>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </div>
