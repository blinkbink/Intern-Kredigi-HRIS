        ...
        <section class="content-header">
            <h1>
                ...
                <div class="col-xs-1 p-h-sm">
                    <a href="<?php echo base_url()."index.php/karyawan"?>"><h6>Kembali</h6></a>
                </div>
            </h1>
        </section>
                                                    ...
                                                    <div align="center" class="col-md-10">
                                                        ...
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <td><input name="sandi_lama" type="password" class="form-control" required
                                                                           oninvalid="this.setCustomValidity('Kata Sandi Lama Tidak Boleh Kosong')"
                                                                           oninput="setCustomValidity('')"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Kata Sandi Baru</td>
                                                                <td><input name="sandi_baru" type="password" class="form-control" required
                                                                           oninvalid="this.setCustomValidity('Kata Sandi Baru Tidak Boleh Kosong')"
                                                                           oninput="setCustomValidity('')"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Konfirmasi Kata Sandi Baru</td>
                                                                <td><input name="ulang_sandi" type="password" class="form-control" required
                                                                           oninvalid="this.setCustomValidity('Konfirmasi Kata Sandi Baru Tidak Boleh Kosong')"
                                                                           oninput="setCustomValidity('')"></td>
                                                            </tr>
                                                        </table>
