                    ...
                    <div class="box box-success ">
                        ...
                        foreach ($data as $d) {
                                ...
                                <div class="box-header with-border">
                                    <h3 class="box-title">Tim Saya <?php echo $d['nama_tim'] ?></h3>
                                </div>
                                <div class="box-body p-med">
                                    <div class="col-md-5 col-xs-12">
                                        ...
                                        <div class="col-sm-19">
                                            <div class="right col-xs-5 text-center">
                                                <img src="<?php echo base_url() . "image/karyawan/" . $d['profil_picture'] . ".jpg" ?>"
                                                     width="75" alt="" class="img-circle img-responsive">
                                            </div>
                                            <div class="left col-xs-7">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><i class="fa fa-building"></i><?php echo $d['email_karyawan'] ?>
                                                    </li>
                                                    <li><i class="fa fa-phone"></i><?php echo $d['hp_karyawan'] ?></li>
                                                </ul>
                                            </div>
                                            <hr>
                                        ...
                                        <div id="cnvsContainer">
                                            <canvas id="canvas" width="422" height="168"
                                                    style="width: 338px; height: 250px;"></canvas>
                                        </div>
                                    </div>
                                </div>
                                <?php
                            ...
                            echo "<h3 align='center'>Belum Ada Tim</h3>";
                        }
                        ?>
                    </div>
                </div>
