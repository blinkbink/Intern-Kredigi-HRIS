                                                                ...
                                                                foreach ($absensi as $d) {
                                                                    ...
                                                                    <tr class="even pointer">
                                                                        <td class=" "><?php
                                                                            ...
                                                                            $convert =  strtotime($d['date']);
                                                                            echo $hari[date("w", $convert)].", ".date("j", $convert)." ".$bulan[date("n", $convert)]." ".date("Y", $convert);
                                                                            ?></td>
                                                                        <td class=" ">
                                                                        <?php
                                                                        //var_dump($status);
                                                                        /*if($d['status_kehadiran'] == $status[0]['id_status_kehadiran']){
                                                                            echo $status[0]['nama_status'];
                                                                        }*/
                                                                            echo $d['nama_status'];
                                                                        ?>
                                                                        </td>
                                                                        <td class=" "><?php echo $d['clock_in'] ?></td>
                                                                        <td class=" "><?php echo $d['clock_out'] ?></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                            }
