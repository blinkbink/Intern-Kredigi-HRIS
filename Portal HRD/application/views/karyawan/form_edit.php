        ...
        <div class="box-body">
                       ...
                       <input type="hidden" name="karyawan_ID" value="<?=get_segment(3)?>" required="">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <label for="kodeAbsensi" class="col-md-4 control-label">Kode Absensi</label>
                                <div class="col-md-8">
                                    <input type="text" name="kode_absensi" id="kode_absensi" class="form-control" value="<?=$karyawan->kode_absensi?>">
                                </div>
                            </div>
                            <div class="form-group">
