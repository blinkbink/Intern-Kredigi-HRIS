...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Izin Sakit</h3>
        ...
        <div class="box-body">
            <button onclick="location.href='<?php echo base_url(). "index.php/izin/add_sakit"?>'" class="btn display-block font-normal btn-success">+ Pengajuan Sakit</button>
            <br><br>
            ...
            <table class="table table-hover table-striped" id="datatable">
                ...
                if($sakit != null)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $convert = strtotime($value['tanggal_sakit']);
                            echo $hari[date("w", $convert)].", ".date("j", $convert)." ".$bulan[date("n", $convert)]." ".date("Y", $convert);
                            ?>
                        </td>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?=site_url('izin/detail_sakit/'.$value['id_sakit'])?>" type="button" class="btn btn-sm btn-info" >
                                    <i class="fa fa-file" data-toggle="tooltip" data-placement="bottom" role="presentation" title="Detail"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-warning hapus-pengumuman" data-id="<?=$value['id_sakit']?>" jumlah_hari="<?=$value['jumlah_hari']?>" tanggal_sakit="<?=$value['tanggal_sakit']?>" data-karir="0" karyawan_ID="<?=$value['karyawan_ID']?>">
