...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Form Izin Sakit</h3>
        ...
        <div class="box-body">
            <form action="<?php echo base_url("index.php/izin/add_sakit")?>" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="input-group date datepicker" >
                                            <input name="tanggal_sakit" id="datepicker" readonly required class="form-control" placeholder="" type="text">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input name="surat_dokter" id="file_input" class="form-control"  type="file" size="20" accept="image/jpg,image/png,image/jpeg" ><br><?php
                                        if(isset($error))
                                        {
                                            echo $error;
                                        }
