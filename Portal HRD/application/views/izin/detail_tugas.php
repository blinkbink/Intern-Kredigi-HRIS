...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Detail Tugas Luar Kantor</h3>
                            ...
                            <div align="center" class="col-md-12">
                                ...
                                foreach($data as $d) {
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $convert = strtotime($d['tanggal_penetapan']);
                                                ...
                                                <tr>
                                                    <th>Tanggal Izin Tugas</th>
                                                    <td>
                                                        <?php
                                                        $hari = array("Minggu","Senin","Selasa","Rabu","Kamis","Jumat","Sabtu");
                                                        $bulan = array("","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");

                                                        $convert = strtotime($d['tanggal_tugas']);
                                                        echo $hari[date("w", $convert)].", ".date("j", $convert)." ".$bulan[date("n", $convert)]." ".date("Y", $convert);
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning hapus-pengumuman" data-id="<?=$d['id_tugas']?>" jumlah_hari="<?=$d['jumlah_hari']?>" tanggal_tugas="<?=$d['tanggal_tugas']?>" data-karir="0" id_tugas="<?=$d['id_tugas']?>" karyawan_ID="<?=$d['karyawan_ID']?>">
                                            Ubah Persetujuan</i>
                                        </button>
                                    </div>
                                    <?php
                ...
                <div class="modal-content">
                    <form action="<?php echo base_url("index.php/izin/ubah_tugas") ?>" role="form" class="form-horizontal" method="post">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">Persetujuan Izin Tugas Luar Kantor</h4>
                        </div>
...
<script>
    $(function () {
        ...
        $(".hapus-pengumuman").click(function(){
            ...
            var divWaktu = $(this).attr('id_tugas');
