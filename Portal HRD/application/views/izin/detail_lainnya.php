...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">Izin</a></li>
        <li class="active">Detail Lainnya</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Detail Izin Lainnya</h3>
            <a href="<?php echo base_url("index.php/izin/lainnya")?>">Kembali</a>
                            ...
                            <div align="center" class="col-md-12">
                                ...
                                foreach($data as $d) {
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning hapus-pengumuman" data-id="<?=$d['id_izin']?>" jumlah_hari="<?=$d['jumlah_hari']?>" tanggal_izin="<?=$d['tanggal_izin']?>" data-karir="0" id_izin="<?=$d['id_izin']?>" karyawan_ID="<?=$d['karyawan_ID']?>">
                                            Ubah Persetujuan</i>
                                        </button>
                                    </div>
                                    <?php
...
<script>
    $(function () {
        ...
        $(".hapus-pengumuman").click(function(){
            ...
            var divWaktu = $(this).attr('id_izin');
