...
<section class="content">
    ...
    <div class="box">
            ...
            <button class="btn  btn-md btn-success  pull-right" data-toggle="modal"><i class="fa fa-plus"></i>
<a href="<?=site_url('pengaturan/pola_kerja/form')?>" class="btn btn-success btn-sm"  data-toggle="tooltip" title="Tambah Pola Kerja">Tambah Pola Kerja</a><button>
            </div>
            <!-- /.box-header -->
		 ...
		 <?php if($value['row'] == 0){?>
		<tr>Data kosong, silahkan buat pola kerja yang baru</tr>
		 <?php } else {?>
                <tr>
		  <td><?php echo $i; $i++ ?></td>
                  <td><?=$value['nama_polker']?></td>
                  <td><?=$value['totalHari']?> Hari</td>
                  <td><?=$value['totalHariKerja']?> Hari</td>
                  <td><?=$value['totalHariLibur']?> Hari</td>
                  <td>
                    <div class="btn-group">
                      <a href="<?=site_url('pengaturan/pola_kerja/list/detail/'.$value['id_polker'])?>" type="button" class="btn btn-sm btn-info" >
                        <i class="fa fa-file" data-toggle="tooltip" data-placement="bottom" role="presentation" title="Detail Pola Kerja"></i>
                      </a>
                      <a href="<?=site_url('pengaturan/pola_kerja/list/edit/'.$value['id_polker'])?>" type="button" class="btn btn-sm btn-warning" >
                        <i class="fa fa-pencil" data-toggle="tooltip" data-placement="bottom" role="presentation" title="Ubah Pola Kerja"></i>
                      </a>
                      <button type="button" class="btn btn-sm btn-danger hapus-slip" data-id="<?=$value['id_polker']?>" >
				  ...
				  <div class="form-group">
                     ...
                     <div class="modal fade" tabindex="-1" role="dialog" id="hapus-slip">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">Hapus Pola Kerja</h4>
                            </div>
                            <div class="modal-body">
...
$(document).ready(function(){
  ...
  $('.datepicker').datepicker({
   ...
   $(".hapus-slip").click(function(){
    ...
    $('#hapus-slip .modal-footer a').attr('href', '<?php echo site_url()?>/pengaturan/pola_kerja/list/hapus/'+divID+''); 
  });
});
</script>
</body>
