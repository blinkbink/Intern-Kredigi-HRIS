<aside class="main-sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?=aktif_page('pengaturan','1','active'); ?>">
          ...
          <ul class="treeview-menu">
			...
			<li><a href="<?=site_url('pengaturan/pola_kerja') ?>"><i class="fa fa-circle-o"></i> <span>Pola & Jadwal Kerja</span></a></li>
          </ul>
        </li>
	...
	<!-- <li>
          <a href="<?=site_url('kasbon') ?>">
            <i class="fa fa-usd"></i> <span>Kelola Kasbon (perlu enggak?)</span>
          </a>
        </li> -->
	<li class="treeview <?=aktif_page('izin','1','active') ;?>">
          <a href="#">
            <i class="fa fa-book"></i><span>Perizinan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li <?=aktif_page('sakit','2','class="active"'); ?>>
              <a href="<?=site_url('izin/sakit') ?>"><i class="fa fa-circle-o"></i> <span>Pengajuan Sakit</span></a>
            </li>
            <li <?=aktif_page('izin','2','class="active"'); ?>>
              <a href="<?=site_url('izin/lainnya') ?>"><i class="fa fa-circle-o"></i> <span>Pengajuan Izin</span></a>
            </li>
            <li <?=aktif_page('izin','2','class="active"'); ?>>
              <a href="<?=site_url('izin/tugas') ?>"><i class="fa fa-circle-o"></i> <span>Pengajuan Tugas Luar Kantor</span></a>
            </li>
          </ul>
        </li>
	<li class="treeview <?=aktif_page('kelolacuti','1','active') ;?>">
          <a href="#">
            <i class="fa fa-book"></i><span>Kelola Cuti</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
                        <li <?=aktif_page('data','2','class="active"'); ?>>
              <a href="<?=site_url('cuti/data') ?>"><i class="fa fa-circle-o"></i> <span>Data Cuti</span></a>
            </li>
                        <li <?=aktif_page('pengajuancuti','2','class="active"'); ?>>
              <a href="<?=site_url('cuti/pengajuan') ?>"><i class="fa fa-circle-o"></i> <span>Pengajuan Cuti</span></a>
            </li>
                        <li <?=aktif_page('sisacuti','2','class="active"'); ?>>
              <a href="<?=site_url('cuti/sisa') ?>"><i class="fa fa-circle-o"></i> <span>Sisa Cuti Awal</span></a>
	    </li>
                        <li <?=aktif_page('unpaidleave','2','class="active"'); ?>>
              <a href="<?=site_url('cuti/unpaidleave') ?>"><i class="fa fa-circle-o"></i> <span>Unpaid Leave</span></a>
	    </li>
          </ul>
        </li>
	<li>
          <a href="<?=site_url('pengumuman') ?>">
            <i class="fa fa-usd"></i> <span>Buat Pengumuman</span>
          </a>
        </li>
      </ul>
    </section>
