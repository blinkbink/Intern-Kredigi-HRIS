...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <button onclick="location.href='<?php echo base_url(). "index.php/cuti/add_cuti"?>'" class="btn display-block font-normal btn-success">+ Pengajuan Cuti</button>
            <br><br>
                ...
                if($cuti != null)
                {
                    ...
                    { ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                $convert = strtotime($value['tanggal_cuti']);
                                echo $hari[date("w", $convert)].", ".date("j", $convert)." ".$bulan[date("n", $convert)]." ".date("Y", $convert);
                                ?>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?=site_url('cuti/detail_cuti/'.$value['id_cuti'])?>" type="button" class="btn btn-sm btn-info" >
                                        <i class="fa fa-file" data-toggle="tooltip" data-placement="bottom" role="presentation" title="Detail"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm btn-warning hapus-pengumuman" data-id="<?=$value['id_cuti']?>" jumlah_hari="<?=$value['lama_cuti']?>" tanggal_sakit="<?=$value['tanggal_cuti']?>" data-karir="0" karyawan_ID="<?=$value['karyawan_ID']?>">
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="myModal">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <form action="<?php echo base_url("index.php/cuti/ubah_cuti") ?>" role="form" class="form-horizontal" method="post">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">Persetujuan Pengajuan Cuti</h4>
                            </div>
                            <div class="modal-body">
                                <table class="table">
                                    <tr>
                                        <td>Ubah Persetujuan
                                            <input type="hidden" name="id_cuti" id="id_data" value="">
