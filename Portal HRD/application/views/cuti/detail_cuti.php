...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">Cuti</a></li>
        <li class="active">Detail Cuti</li>
    </ol>
</section>
                            ...
                            <div align="center" class="col-md-12">
                                ...
                                foreach($data as $d) {
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning hapus-pengumuman" data-id="<?=$d['id_cuti']?>" jumlah_hari="<?=$d['lama_cuti']?>" tanggal_sakit="<?=$d['tanggal_cuti']?>" data-karir="0" id_sakit="<?=$d['id_cuti']?>" karyawan_ID="<?=$d['karyawan_ID']?>">
                                            Ubah Persetujuan</i>
                                        </button>
                                    </div>
                                    <?php
