                                            ...
                                            <div class="x_content">
                                                <div align="center" class="col-md-12">
                                                    <div class="table-responsive">
                                                        <form action="<?php base_url()."karyawan/pengumuman"?>" method="post">
                                                                ...
                                                                foreach ($data as $d) {
                                                                    ...
                                                                    <tr class="even pointer">
                                                                        <td>
                                                                            ...
                                                                            echo date('j F o', $date);
                                                                            ?>
                                                                        </td>
                                                                        <td><?php echo $d['judul'] ?></td>
                                                                        <td><a href="<?php echo base_url(). "pengumuman/pesan_pengumuman/".$d['idpengumuman']?>">Baca</a></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                            }
