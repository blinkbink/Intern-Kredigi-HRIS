                                                    ...
                                                    <div align="center" class="col-md-10">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="input-group date datepicker" >
                                                                        <input name="tanggal_izin" id="datepicker" required class="form-control" placeholder="" aria-describedby="basic-addon2" value="" readonly="" type="text">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input name="jumlah_hari" type="number" max="4" min="1" class="form-control" required><font color="red">*</font> Maksimal 4 hari</td>
                                                            </tr>
