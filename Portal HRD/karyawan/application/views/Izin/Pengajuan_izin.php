...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-file"></i> Pengajuan Izin</a></li>
            </ol>
        </section>
                                                        ...
                                                        foreach ($status as $st)
                                                            if($st['total'] >= 2) {
                                                                ...
                                                                <div align="center" class="col-md-5">
                                                                    <button onclick="location.href='<?php echo base_url() . "izin/form_izin" ?>'" disabled class="btn display-block font-normal btn-success">+ Pengajuan Izin</button>
                                                                </div>
                                                                <br><br><br>
                                                                ...
                                                                ?>
                                                                <div align="center" class="col-md-5">
                                                                    <button onclick="location.href='<?php echo base_url(). "izin/form_izin"?>'" class="btn display-block font-normal btn-success">+ Pengajuan Izin</button>
                                                                </div>
                                                                <?php
                                                            }
                                                        ?>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped jambo_table bulk_action">
                                                                ...
                                                                <tr class="success">
                                                                    ...
                                                                    <th class="column-title">Lama Izin </th>
                                                                ...
                                                                if($data != null)
                                                                {
                                                                    foreach ($data as $d) {
                                                                        ...
                                                                        <tr class="even pointer">
                                                                            ...
                                                                            <td class=" ">
                                                                                <?php
                                                                                $convert = date('j F o', strtotime($d['tanggal_izin']));
                                                                                echo $convert
                                                                                ?>
                                                                            </td>
                                                                            ...
                                                                            <td class=" ">
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <a href="izin/detail_izin/<?php echo $d['id_izin']?>">Lihat</a>
                                                                                    <a href="izin/batal_izin/<?php echo $d['id_izin']?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan izin ini ?')">Batal</a>
                                                                                    <a href="izin/edit_izin/<?php echo $d['id_izin']?>">Edit</a>
                                                                                    <?php
                                                                                }
                                                                                else if ($d['status'] == "Di Setujui" || $d['status'] == "Batal" || $d['status'] == "Tidak Di Setujui"){
                                                                                    ?>
                                                                                    <a href="izin/detail_izin/<?php echo $d['id_izin']?>">Lihat</a>
                                                                                    <?php
                                                                                }
