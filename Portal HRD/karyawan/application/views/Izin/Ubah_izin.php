                                                    ...
                                                    <div align="center" class="col-md-10">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="input-group date datepicker" >
                                                                        <input value="<?php echo date("d-m-Y", strtotime($d['tanggal_izin']))?>" name="tanggal_izin" class="form-control" placeholder="" aria-describedby="basic-addon2" value="" readonly="" type="text" onchange="this.form.submit()">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input value="<?php echo $d['jumlah_hari']?>" name="jumlah_hari" type="number" max="4" min="1" class="form-control" required><font color="red">*</font> Maksimal 4 hari</td>
                                                            </tr>
