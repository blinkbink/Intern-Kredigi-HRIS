        ...
        <section class="content-header">
            <h1>
                ...
                <div class="col-xs-1 p-h-sm">
                    <a href="<?php echo base_url()."sakit"?>"><h6>Kembali</h6></a>
                </div>
            </h1>
            <ol class="breadcrumb">
                                                    ...
                                                    <div align="center" class="col-md-10">
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <td><?php echo date("j F o", strtotime($d['tanggal_pengajuan'])); ?></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="input-group date datepicker" >
                                                                        <input name="tanggal_izin" class="form-control" value="<?php echo date("m/d/Y", strtotime($d['tanggal_sakit'])); ?>" placeholder="" aria-describedby="basic-addon2" value="" readonly="" type="text" onchange="this.form.submit()">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input name="jumlah_hari" value="<?php echo $d['jumlah_hari']?>" type="number" max="7" min="1" class="form-control"><font color="red">*</font> Maksimal 7 hari</td>
                                                            </tr>

                                                            <tr>
                                                                <td>Keterangan</td>
                                                                <td><textarea value="<?php echo $d['keterangan']?>" name="keterangan" style="overflow:auto;resize:none" rows="6" cols="110" required oninvalid="this.setCustomValidity('Keterangan Tidak Boleh Kosong')" oninput="setCustomValidity('')"><?php echo $d['keterangan']?></textarea></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Surat Keterangan Dokter</td>
                                                                <td><input value="<?php echo $d['file'] ?>" name="surat_dokter" type="file" size="20"><br><font color="red">*</font> File yang di bolehkan : png, jpg (Ukuran Maksimal 2 mb)</td>
                                                            </tr>
                                                        </table>
