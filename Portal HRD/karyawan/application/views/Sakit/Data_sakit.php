...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-money"></i> Detail Pengajuan Sakit</a></li>
            </ol>
        </section>
                                                ...
                                                foreach($data as $d) {
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <div align="center" class="col-md-3">
                                                            <img src="<?php echo base_url() . "image/karyawan/" . $d['img'] . ".jpg" ?>"
                                                                 class="img-thumbnail"
                                                        ...
                                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                        $convert = date('j F o', strtotime($d['tanggal_pengajuan']));
                                                                        echo $convert
                                                                        ?>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <th>Jumlah Hari Izin Sakit</th>
                                                                    <td><?php echo $d['jumlah_hari'] ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Surat Keterangan Dokter</th>
                                                                    <td>
                                                                        <a href="<?php echo base_url() . "uploads/" . $d['file'] . "" ?>"><img src="<?php echo base_url()."assets/icon/pdf.png"?>" width="20"> </a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Keterangan</th>
