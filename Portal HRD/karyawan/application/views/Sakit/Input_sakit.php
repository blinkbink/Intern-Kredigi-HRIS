                                        ...
                                        <div class="x_content">
                                            <div align="center" class="col-md-12">
                                                <div class="table-responsive">
                                                    <?php echo form_open_multipart('sakit/form_sakit');?>
                                                    <div align="center" class="col-md-10">
                                                        <table class="table">
                                                            <tr>
                                                                <td>Tanggal Pengajuan</td>
                                                                <td><?php echo date("j F o"); ?> (Hari Ini)</td>
                                                                <td><input name="tanggal_pengajuan" type="hidden" value="<?php echo date("Y-m-d");?>" class="form-control" ></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tanggal Sakit</td>
                                                                <td>
                                                                    <div class="input-group date datepicker" >
                                                                        <input name="tanggal_izin" id="datepicker" class="form-control" required placeholder="" aria-describedby="basic-addon2" value="" readonly="" type="text" onchange="this.form.submit()">
                                                                        <span class="input-group-addon add-on" id="basic-addon2"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </td></tr>
                                                            <tr>
                                                                <td>Jumlah Hari Sakit</td>
                                                                <td><input name="jumlah_hari" type="number" max="7" min="1" class="form-control"><font color="red">*</font> Maksimal 7 hari</td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input name="surat_dokter" type="file" size="20"><br><font color="red">*</font> File yang di bolehkan : png, jpg (Ukuran Maksimal 2 mb)</td>
                                                            </tr>
                                                        </table>
