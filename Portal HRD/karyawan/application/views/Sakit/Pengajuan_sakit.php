                                                        ...
                                                        foreach ($status as $st)
                                                            if($st['total'] >= 2) {
                                                                ...
                                                                <div align="center" class="col-md-5">
                                                                    <button onclick="location.href='<?php echo base_url(). "sakit/form_sakit"?>'" disabled class="btn display-block font-normal btn-success">+ Pengajuan Sakit</button>
                                                                </div>
                                                                <br><br><br>
                                                                ...
                                                                ?>
                                                                <div align="center" class="col-md-5">
                                                                    <button onclick="location.href='<?php echo base_url(). "sakit/form_sakit"?>'" class="btn display-block font-normal btn-success">+ Pengajuan Sakit</button>
                                                                </div>
                                                                <?php
                                                            }
                                                        ?>
                                                                ...
                                                                if($data != null)
                                                                {
                                                                    foreach ($data as $d) {
                                                                        ...
                                                                        <tr class="even pointer">
                                                                            ...
                                                                            <td class=" ">
                                                                                <?php
                                                                                $convert = date('j F o', strtotime($d['tanggal_sakit']));
                                                                                echo $convert
                                                                                ?>
                                                                            </td>
                                                                            ...
                                                                            <td class=" ">
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <a href="sakit/detail_sakit/<?php echo $d['id_sakit']?>">Lihat</a>
                                                                                    <a href="sakit/batal_sakit/<?php echo $d['id_sakit']?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan sakit ini ?')" >Batal</a>
                                                                                    <a href="sakit/edit_sakit/<?php echo $d['id_sakit']?>">Edit</a>
                                                                                    <?php
                                                                                }
