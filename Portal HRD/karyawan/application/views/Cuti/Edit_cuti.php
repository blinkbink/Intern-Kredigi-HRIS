        ...
        <section class="content-header">
            <h1>
                ...
                <div class="col-xs-1 p-h-sm">
                    <a href="<?php echo base_url()."cuti"?>"><h6>Kembali</h6></a>
                </div>
            </h1>
            <ol class="breadcrumb">
                                                    ...
                                                    <div align="center" class="col-md-10">
                                                        ...
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <td><?php echo date("j F o", strtotime($d['tanggal_pengajuan'])); ?> (Hari Ini)</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="input-group date datepicker" >
                                                                        <input value="<?php echo date("d-m-Y", strtotime($d['tanggal_cuti']))?>" name="tanggal_cuti" class="form-control" placeholder="" aria-describedby="basic-addon2" value="" readonly="" type="text" onchange="this.form.submit()">
                                                            ...
                                                            <tr>
                                                                <td>Lama Cuti</td>
                                                                <td><input value="<?php echo $d['lama_cuti']?>" name="lama_cuti" type="number" max="12" min="1" class="form-control" required><font color="red">*</font> Minimal 1 hari, Sisa Jatah Cuti * Hari</td>
                                                            </tr>
