...
class Root extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->helper(array('form', 'security' ,'cookie','tgl_indo_helper','url','template_helper','user_helper','date'));
	...
	public function index(){
		...
		if(isset($post['username']) ){ 
			$this->user_detail = $this->User_model->get_by(array('username' => $post['username'], 'group' => 'superadmin'), 1, NULL, TRUE);
		}
