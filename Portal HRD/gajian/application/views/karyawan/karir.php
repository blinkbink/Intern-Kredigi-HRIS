...
<div class="pull-left image">
          <img src="http://localhost/gajian/assets/AdminLTE-2.3.11/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" width="40px">
                  ...
                  <a href="<?=site_url('karyawan/detail/'.$key)?>" ><?=$this->Karyawan_model->get_karyawan_detail($key,'nama_lengkap')?></a><br>Mulai dari <?=tgl_indo($this->Karyawan_model->get_karyawan_detail($key,'mulai_kerja'))?></td>
                  <?php if(!empty($value)) {?>
