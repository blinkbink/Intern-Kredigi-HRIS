				...
				if (this.datasets && this.datasets.length > 1) {
					...
					medianPosition = (function(index) {
						...
						var total = {
							...
							jumlahData : this.options.jumlahData,
							value: 0,
					...
					// Jumlah Data
						var total = 0;
						ChartElements.forEach(function(v) {
							total += v.value; // Menjumlahkan value2 per harinya
						});
					...
					new Chart.MultiTooltip({
						...
						title: ChartElements[0].label+" ("+ total+" Orang)", // Menampilkan total value yang telah dijumlahkan perharinya
						chart: this.chart,
						ctx: this.chart.ctx,
